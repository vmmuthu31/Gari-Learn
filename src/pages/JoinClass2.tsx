    ...
    <>
      ...
      <div className="rounded-md px-10 py-20 shadow-lg p-4">
        <div className="aspect-w-20 px-60 aspect-h-9">
          <Player
            src={'https://ipfs.io/ipfs/QmR7cDW2W77UFzZUA5cyMuQq2dB44rDqAmpMkeVucyeSpX'}
            showPipButton
            showTitle={false}
            aspectRatio="16to9"
            controls={{
          ...
          />
          <h2 className="text-lg font-bold mb-4">Learn CyberSecurity Basics</h2>
          <div className='flex justify-between'>
            <p className="text-gray-500 mb-4">Instructor: Mr. Kumaran</p>
            {isComplete ? (
